...
if(isset($received) && count($received) > 0)
{
	...
	$receivedUpdate = mysql_query("UPDATE installment_master SET hub_received=1, hub_id=".$_SESSION[ADMIN_SESSION_VAR].", hub_receive_date='".$today."' WHERE id IN (".$receiveStr.") AND hub_id = 0");
}
...
if(isset($branch_despatched) && count($branch_despatched) > 0)
{
	...
	$sql= "UPDATE installment_master SET branch_despatched=1, branch_despatch_date='".$today."' WHERE id IN (".$branch_despatchedStr.")";
	//echo $sql;
	//exit;
