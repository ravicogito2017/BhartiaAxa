...
$where = "WHERE is_deleted=1 AND branch_id='".$_SESSION[ADMIN_SESSION_VAR]."'";
  ...
  <tbody>
    <tr> 
      ...
      <td colspan="14" align="right">
        <a title=" Export to Excel " href="<?=URL?>deleted_transaction_excel_branch.php" ><img src="images/excel_icon.gif" border="0" title="Download" /></a>
      </td>
    </tr>
		<tr> 
      <td colspan="14" align="right">
