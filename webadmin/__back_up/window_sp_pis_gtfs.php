...
if(isset($_POST['phpSum']) && $_POST['phpSum'] != '')
{
	...
	$sql="INSERT INTO pis_sp_master_gtfs SET 
	...
	$previousID = mysql_insert_id();
		...
		$update_main_payment = "UPDATE insurance_short_premium_gtfs SET pis_id='".$previousID."' WHERE id IN(".$_POST['idstr_alt_payment'].")";
