...
?>
	...
	<tr> 			
			...
			<td width="8%" align="center" valign="top" ><a href="javascript:void(0)" onclick="javascript:popUp('<?php echo URL; ?>webadmin/window_pis_sicl_renewal.php?id=<?php echo base64_encode($mysql_id); ?>')">View</a></td>
