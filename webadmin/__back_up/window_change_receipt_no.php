...
if(isset($_GET['id']) && !empty($_GET['id']))
{
	...
	//echo $invoice_id;
	if(isset($_POST['receipt_number']) && $_POST['receipt_number'] != '')
	{
		//echo '<pre>';
		//print_r($_POST);
		//echo '</pre>';
	...
	if($numTransaction > 0)
		{
			...
			$receipt_date = date('d-m-Y', strtotime($getTransaction['deposit_date']));
...
<script type="text/javascript" src="<?=URL?>js/site_scripts.js"></script>
 ...
 <form name="addForm" id="addForm" action="" method="post" >
    ...
    <tr class="TDHEAD"> 
      <td colspan="3">Update Receipt No.</td>
    </tr>
    ...
    <tr> 
      ...
      <td class="tbllogin" valign="top" align="center">:</td>
      <td valign="top" align="left">
				<input name="deposit_date" id="deposit_date" type="text" class="inplogin"  value="<?php echo $deposit_date; ?>" maxlength="100" readonly /> &nbsp;<!-- <img src="images/cal.gif" alt="" style="border: 0pt none ; cursor: pointer; position: absolute;" onclick="displayCalendar(document.addForm.deposit_date,'dd-mm-yyyy',this)" width="20" height="18"> -->
			</td>
    </tr>
      ...
      <td class="tbllogin" valign="top" align="center">:</td>
      <td valign="top" align="left">
				<input name="receipt_date" id="receipt_date" type="text" class="inplogin"  value="<?php echo $receipt_date; ?>" maxlength="100" readonly /> &nbsp;<!-- <img src="images/cal.gif" alt="" style="border: 0pt none ; cursor: pointer; position: absolute;" onclick="displayCalendar(document.addForm.receipt_date,'dd-mm-yyyy',this)" width="20" height="18"> -->
			</td>
    </tr>
 ...
 -->
      ...
      <td class="tbllogin" valign="top" align="center">:</td>
      <td valign="top" align="left"><input type="text" name="receipt_number" value="<?php echo $receipt_number; ?>" class="inplogin" style="width:300px; " onKeyUp="this.value = this.value.toUpperCase();" ></td>
    </tr>
		<!-- <tr> 
      ...
      <td class="tbllogin" valign="top" align="center">:</td>
      <td valign="top" align="left">
				<input type="text" name="receipt_number" class="inplogin" value="<?php echo $receipt_number; ?>" onKeyPress="return keyRestrict(event, '0123456789.')">
			</td>
    </tr> -->
		<!-- <tr> 
