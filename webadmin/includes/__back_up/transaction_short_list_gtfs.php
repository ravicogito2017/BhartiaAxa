...
$Query = "select count(id) as CNT from insurance_short_premium_gtfs  ".$where;
//echo $Query;
//exit;
...
$Query = "SELECT * FROM insurance_short_premium_gtfs ".$where.$OrderBY.$Limit;
  ...
  <tbody>
    <tr> 
      ...
      <td colspan="25" align="right">
        <a title=" Export to Excel " href="<?=URL?>short_premium_excel_gtfs_admin.php" ><img src="images/excel_icon.gif" border="0" title="Download" /></a>
      </td>
    </tr>
...
?>
	<tr> 
      <td width="8%" align="center" valign="top" ><?php echo (intval($rs[$i]['pis_id']) != 0 ? 'Yes' : 'No'); ?></td>
			...
			//} ?></td>	 -->
			<td width="8%" align="center" valign="top" >			
				<a href="javascript:void(0)" onclick="javascript:popUp('<?php echo URL; ?>webadmin/window_sp_gtfs.php?id=<?php echo base64_encode($mysql_id); ?>')">Generate</a>		
			</td>
			<?php
			...
			<a href="javascript:void(0)" onclick="javascript:popUp('<?php echo URL; ?>webadmin/window_cancel_short_gtfs.php?id=<?php echo base64_encode($mysql_id); ?>')">Cancel</a>
