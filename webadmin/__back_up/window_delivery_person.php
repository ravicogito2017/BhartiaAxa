...
if(isset($_GET['id']) && !empty($_GET['id']))
{
	...
	if(isset($_POST['delivery_person_name']) && ($_POST['delivery_person_name'] != '') && isset($_POST['delivery_person_emp_code']) && ($_POST['delivery_person_emp_code'] != ''))
	{
		#echo '<pre>';
		#print_r($_POST);
		#echo '</pre>';
		...
		extract($_POST);
				...
				$folio_query = "UPDATE customer_folio_no SET delivery_person_name = '".$delivery_person_name."', delivery_person_emp_code = '".$delivery_person_emp_code."', admin_despatch_date = '".date('Y-m-d')."' WHERE id='".$folio_id."'";
...
<script type="text/javascript" src="<?=URL?>js/site_scripts.js"></script>
 ...
 <form name="addForm" id="addForm" action="" method="post" onsubmit="return dochk()">
    ...
    <tr class="TDHEAD"> 
      <td colspan="3">View Delivery Person Info for HO</td>
    </tr>
