...
$pid 			= loadVariable('pid',0);
	...
	if(isset($pis_mode))
	{
		$_SESSION['short_premium_payment_mode'] = $pis_mode;
	}
	...
	{
		$where.= ' AND pis_mode ="'.$_SESSION['short_premium_payment_mode'].'"';
	}
...
$Query = "select count(id) as CNT from pis_sp_master_gtfs ".$where;
#echo $Query;
...
$Query = "SELECT * FROM pis_sp_master_gtfs ".$where.$OrderBY.$Limit;
  ...
  <tbody>
    <tr> 
      ...
      <td colspan="20" align="right">
        <a title=" Export to Excel " href="<?=URL?>pis_sp_excle_gtfs.php" ><img src="images/excel_icon.gif" border="0" title="Download" /></a>
      </td>
    </tr>
		<?php
			}	
	...
	<tr> 
      <td colspan="20" align="left">
				...
				<tr>
					...
					?>
					<tr>
						<td width="150"><strong>Date<!-- <font color="#ff0000">*</font> --></strong></td>
						<td width="20"><strong>:</strong></td>
						<td width="150">
					...
					<tr>
						...
						<td width="150">
							<select id="mode" name="pis_mode" class="inplogin_select">
								<option value="" >Select</option>
								<option value="CASH" <?php echo ($_SESSION['short_premium_payment_mode'] == 'CASH' ? 'selected' : ''); ?>>CASH</option>
								<option value="CHEQUE" <?php echo ($_SESSION['short_premium_payment_mode'] == 'CHEQUE' ? 'selected' : ''); ?>>CHEQUE</option>	
								<option value="DD" <?php echo ($_SESSION['short_premium_payment_mode'] == 'DD' ? 'selected' : ''); ?>>DD</option>							
							</select>
						</td>
					</tr>
					...
					<tr>
						...
						?>
							<input type="button" name="btnPis" value="Generate PIS" class="inplogin" onclick="javascript:popUp('<?php echo URL; ?>webadmin/window_sp_pis_gtfs.php?pisdate=<?php echo $_POST['from_date']?>&pismode=<?php echo $_POST['pis_mode']?>')">
						<?php
						}	
						?>
						</td>
...
?>
	...
	<tr> 			
			...
			<td width="8%" align="center" valign="top" ><a href="javascript:void(0)" onclick="javascript:popUp('<?php echo URL; ?>webadmin/window_sp_pis_admin_gtfs.php?id=<?php echo base64_encode($mysql_id); ?>')">View</a></td>
