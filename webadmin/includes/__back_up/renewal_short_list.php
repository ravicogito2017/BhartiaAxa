...
$Query = "select count(id) as CNT from renewal_short_premium  ".$where;
//echo $Query;
//exit;
...
$Query = "SELECT * FROM renewal_short_premium ".$where.$OrderBY.$Limit;
  ...
  <tbody>
    <tr> 
      ...
      <td colspan="25" align="right">
        <a title=" Export to Excel " href="<?=URL?>short_premium_renewal_excel_admin.php" ><img src="images/excel_icon.gif" border="0" title="Download" /></a>
      </td>
    </tr>
...
?>
	<tr> 
	  ...
	  <br />
			...
			<a href="javascript:void(0)" onclick="javascript:popUp('<?php echo URL; ?>webadmin/window_sp_r_duplicate_edit.php?id=<?php echo base64_encode($rs[$i]['id']); ?>')">Edit<?php }} ?>
			</td>
			...
			<a href="javascript:void(0)" onclick="javascript:popUp('<?php echo URL; ?>webadmin/window_sp_r_receipt_no_edit.php?id=<?php echo base64_encode($rs[$i]['id']); ?>')">Edit<?php }} ?>			
			</td>
			...
			<td width="8%" align="center" valign="top" ><?php echo $branch_name; ?><br />
			<?php if($_SESSION[ROLE_ID] == '1'){if($branch_name != ""){ ?>
			<a href="javascript:void(0)" onclick="javascript:popUp('<?php echo URL; ?>webadmin/window_sp_r_branch_edit.php?id=<?php echo base64_encode($rs[$i]['id']); ?>')">Edit<?php }} ?>			
			</td>
			<td width="8%" align="center" valign="top" ><?php echo $plan; ?><br />
			<?php if($_SESSION[ROLE_ID] == '1'){if($plan != ""){ ?>
			<a href="javascript:void(0)" onclick="javascript:popUp('<?php echo URL; ?>webadmin/window_sp_r_plan_edit.php?id=<?php echo base64_encode($rs[$i]['id']); ?>')">Edit<?php }} ?></td>
			...
			<a href="javascript:void(0)" onclick="javascript:popUp('<?php echo URL; ?>webadmin/windoe_sp_r_due_date_edit.php?id=<?php echo base64_encode($rs[$i]['id']); ?>')">Edit<?php }} ?>
			...
			<td width="8%" align="center" valign="top" ><?php echo $rs[$i]['amount']; ?>
			
			<br />
			<?php if($_SESSION[ROLE_ID] == '1'){if($plan != ""){ ?>
			<a href="javascript:void(0)" onclick="javascript:popUp('<?php echo URL; ?>webadmin/window_sp_r_amount_edit.php?id=<?php echo base64_encode($rs[$i]['id']); ?>')">Edit<?php }} ?>
			</td>
			...
			//} ?></td>	 -->
			<td width="8%" align="center" valign="top" >			
				<a href="javascript:void(0)" onclick="javascript:popUp('<?php echo URL; ?>webadmin/window_sp_renewal.php?id=<?php echo base64_encode($mysql_id); ?>')">Generate</a>		
			</td>
			<?php
			...
			<a href="javascript:void(0)" onclick="javascript:popUp('<?php echo URL; ?>webadmin/window_cancel_renewal_short.php?id=<?php echo base64_encode($mysql_id); ?>')">Cancel</a>
			<?php } ?>
