...
//$selTransaction = mysql_query("SELECT id, branch_id, customer_id, deposit_date, comitted_amount, amount, tenure, transaction_charges, insured_name, last_name, phone, email FROM renewal_master WHERE is_deleted=0 ORDER BY id DESC");
  ...
  <tbody>
    <tr> 
      ...
      <td colspan="25" align="right">
        <a title=" Export to Excel " href="<?=URL?>renewal_excel.php" ><img src="images/excel_icon.gif" border="0" title="Download" /></a>
      </td>
    </tr>
    ...
    <tr> 
      <td width="8%" align="center" valign="top" class="tbllogin">PIS Generated</td>
			...
			<td width="8%" align="center" valign="top" class="tbllogin"><?php if($_SESSION[ROLE_ID] == '1'){?>
Edit<?php }?></td> 
...
?>
	<tr> 
      <td width="8%" align="center" valign="top" ><?php echo (intval($rs[$i]['pis_id']) != 0 ? 'Yes' : 'No'); ?></td>
			...
			<td width="8%" align="center" valign="top" >			
				<a href="javascript:void(0)" onclick="javascript:popUp('<?php echo URL; ?>webadmin/window_renewal_edit.php?id=<?php echo base64_encode($mysql_id); ?>')"><?php if($_SESSION[ROLE_ID] == '1'){?>Edit<?php }?></a>		
			</td>
			<!-- <td width="8%" align="center" valign="top" >
			<?php //if(intval($kyc_ok) == 1) { ?>
			...
			<a href="javascript:void(0)" onclick="javascript:popUp('<?php echo URL; ?>webadmin/window_cancel_renewal.php?id=<?php echo base64_encode($mysql_id); ?>')">Cancel</a>
			<?php } ?>
			</td>
