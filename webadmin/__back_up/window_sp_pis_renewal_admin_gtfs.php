...
{
	extract($_POST);
	mysql_query("UPDATE pis_sp_renewal_master_gtfs SET cms_no='".$cms_no."', deposit_date='".date('Y-m-d', strtotime($deposit_date))."' WHERE id='".$previousID."'");
...
{
	$selOldRec = mysql_query("SELECT * FROM pis_sp_renewal_master_gtfs WHERE id='".$previousID."'");
...
$where = "WHERE  pis_id='".base64_decode($_GET['id'])."'";
$OrderBY = " ORDER BY id DESC ";



$Query = "SELECT * FROM renewal_short_premium_gtfs ".$where.$OrderBY;
		 ...
		 <tr>
			<td colspan="3" align="center">
				<form method="post" action="" name="cms_frm" onsubmit="return pisCheck()">
					...
					<strong>GOLDEN TRUST FINANCIAL SERVICES<br />
