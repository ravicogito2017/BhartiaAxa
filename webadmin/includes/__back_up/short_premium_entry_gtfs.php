...
//	$invoice_id = base64_decode($_GET['id']);
	...
	if(isset($_POST['short_premium_payment_mode']) && $_POST['short_premium_payment_mode'] != '')
	{
		...
		$insert_short_installment = "INSERT INTO insurance_short_premium_gtfs SET
				...
				$updt_transaction_id = "UPDATE insurance_short_premium_gtfs SET transaction_id = '".$transaction_id."' WHERE id =".$branch_transaction;
				mysql_query($updt_transaction_id);

				header("location: ".URL.'webadmin/index.php?p=transaction_short_list_branch_gtfs');
...
.hotelTabSelect a{ font-family:Verdana, Arial, Helvetica, sans-serif; font-size:11px; font-weight:bold; background:#FFF; color:#000; height:24px; line-height:24px; text-decoration:none; padding:0px 10px 0px 10px; display:block;}
	...
	{	
		...
		{
			alert("Please Enter Pre Receipt No.");
		...
		paymentMode=document.getElementById("short_premium_amount").value;
		if(document.getElementById("short_premium_amount").value < '1')
			{
...
<script type="text/javascript" src="<?=URL?>js/site_scripts.js"></script>
 ...
 <form name="addForm" id="addForm" action="" method="post" onsubmit="return dochk()">
	...
	<tr> 
      ...
      <td width="5%" valign="top" align="center">:</td>
      <td width="68%" align="left"><input name="agent_code" id="agent_code" type="text" class="inplogin"  value="<?php echo $agent_code; ?>" maxlength="100" onKeyUp="this.value = this.value.toUpperCase();" ></td>
    </tr>

<tr> 
      
		<td class="tbllogin" valign="top" align="right">Pre Receipt No.<font color="#ff0000">*</font></td>
      <td width="5%" valign="top" align="center">:</td>
      <td width="68%" align="left"><input name="receipt_number" id="receipt_number" type="text" class="inplogin"  value="<?php echo $receipt_number; ?>" maxlength="100" onKeyUp="this.value = this.value.toUpperCase();" ></td>
    </tr>
...
<input type="hidden" name="branch_name" value="<?php echo $_SESSION[ADMIN_SESSION_VAR]; ?>">
	...
	<tr> 
	 ...
	 <td class="tbllogin" valign="top" align="right">Is Duplicate Entry<font color="#ff0000">*</font></td>
      <td class="tbllogin" valign="top" align="center">:</td>
