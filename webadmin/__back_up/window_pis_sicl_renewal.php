...
{
	mysql_query("INSERT INTO pis_master_sicl_renewal SET 
	...
	{
		$update_main_payment = "UPDATE renewal_master SET pis_id='".$previousID."' WHERE id IN(".$_POST['idstr_main_payment'].")";
	...
	{
		$update_alt_payment = "UPDATE renewal_master SET alt_pis_id='".$previousID."' WHERE id IN(".$_POST['idstr_alt_payment'].")";
 ...
 <div>
	 <table style="width:700px;">		 
		 ...
		 <tr>
			<td colspan="3" align="center">
				<strong>
					<div style="width:49%; float: left; text-align:left; ">Pay In Slip Number (Renewal Entry SICL) : <?php echo (intval($previousID) != 0 ? str_pad($previousID, 7, "0", STR_PAD_LEFT) : ''); ?></div>
