...
$Query = "select count(id) as CNT from pis_sp_renewal_master ".$where;
#echo $Query;
...
$Query = "SELECT * FROM pis_sp_renewal_master ".$where.$OrderBY.$Limit;
  ...
  <tbody>
    <tr> 
      ...
      <td colspan="20" align="right">
        <a title=" Export to Excel " href="<?=URL?>pis_sp_renewal_excel.php" ><img src="images/excel_icon.gif" border="0" title="Download" /></a>
      </td>
    </tr>
		<?php
			}	
      ...
      <td colspan="20" align="left">
				...
				<tr>
					...
					<tr>
						...
						?>
							<input type="button" name="btnPis" value="Generate PIS" class="inplogin" onclick="javascript:popUp('<?php echo URL; ?>webadmin/window_sp_pis_renewal.php?pisfrondate=<?php echo $_POST['from_date']?>&pistodate=<?php echo $_POST['to_date']?>&pismode=<?php echo $_POST['pis_mode']?>')">
						<?php
						}	
						?>
						</td>
...
?>
	...
	<tr> 			
			...
			<td width="8%" align="center" valign="top" ><a href="javascript:void(0)" onclick="javascript:popUp('<?php echo URL; ?>webadmin/window_sp_pis_renewal_admin.php?id=<?php echo base64_encode($mysql_id); ?>')">View</a></td>
