...
<script type="text/javascript" src="<?=URL?>js/site_scripts.js"></script>
 ...
 <form name="addForm" id="addForm" action="" method="post" >
	 ...
	 <table width="700" border="0">
		...
		<tr>
			<td height="30" align="center" colspan="2" valign="top"><strong>INDIVIDUAL ACKNOWLEDGEMENT AT HUB</strong></td>
		</tr>

		<tr>
			<td height="30" align="left" colspan="2" valign="top" style="line-height:20px;">Received the gold / silver coins of ___________ grams by Mr. _______________________________ <br />
			________________________ (Employee at HUB) Emp. Code ___________ against the details which <br />
			are as follows
			</td>
		</tr>		
	...
	<tbody> 
      ...
      <td valign="top" align="left">
		...
		<tr> 
      <td class="tbllogin" valign="top" align="left">First Name</td>
      <td class="tbllogin" valign="top" align="center">:</td>
      <td valign="top" align="left"><?php echo $first_name; ?></td>
    </tr>

		<tr> 
      <td class="tbllogin" valign="top" align="left">Middle Name</td>
      <td class="tbllogin" valign="top" align="center">:</td>
      <td valign="top" align="left"><?php echo $middle_name; ?></td>
    </tr>

		<tr> 
      <td class="tbllogin" valign="top" align="left">Last Name</td>
      <td class="tbllogin" valign="top" align="center">:</td>
      <td valign="top" align="left"><?php echo $last_name; ?></td>
    </tr>

		<tr> 
      <td class="tbllogin" valign="top" align="left">Product Name</td>
      <td class="tbllogin" valign="top" align="center">:</td>
      <td valign="top" align="left"><?php echo $product_name; ?></td>
    </tr>
		<tr> 
      <td class="tbllogin" valign="top" align="left">Commodity Name</td>
      <td class="tbllogin" valign="top" align="center">:</td>
      ...
      <td valign="top" align="left"><?php echo $comitted_amount; ?></td>
		...
		<tr> 
      <td class="tbllogin" valign="top" align="left">Advanced Amount</td>
      <td class="tbllogin" valign="top" align="center">:</td>
      <td valign="top" align="left"><?php echo $getSumData['AMOUNT']; ?></td>
    </tr>

		<tr> 
      <td class="tbllogin" valign="top" align="left">Tax</td>
      <td class="tbllogin" valign="top" align="center">:</td>
      <td valign="top" align="left"><?php echo $getSumData['TRANSACTION_CHARGES']; ?></td>
    </tr>

		<tr> 
      <td class="tbllogin" valign="top" align="left">Grams Accumulated</td>
      <td class="tbllogin" valign="top" align="center">:</td>
      <td valign="top" align="left"><?php echo $getSumData['GOLD_GRAM']; ?></td>
		...
		<tr> 
      <td class="tbllogin" valign="top" align="left">Nominee Name</td>
      <td class="tbllogin" valign="top" align="center">:</td>
      ...
      <td valign="top" align="left"><?php echo $nominee_address; ?></td>
		...
		<tr> 
      <td class="tbllogin" valign="top" align="left">Nominee Relationship</td>
      <td class="tbllogin" valign="top" align="center">:</td>
      <td valign="top" align="left"><?php echo $relationship_type; ?></td>
    </tr>

		<tr> 
      <td class="tbllogin" valign="top" align="left">Appointee Name</td>
      <td class="tbllogin" valign="top" align="center">:</td>
      <td valign="top" align="left"><?php echo $appointee_name; ?></td>
    </tr>

		<tr> 
      <td class="tbllogin" valign="top" align="left">Appointee Relationship</td>
      <td class="tbllogin" valign="top" align="center">:</td>
