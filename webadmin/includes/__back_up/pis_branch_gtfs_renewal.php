...
$Query = "select count(id) as CNT from pis_master_gtfs_renewal ".$where;
#echo $Query;
...
$Query = "SELECT * FROM pis_master_gtfs_renewal ".$where.$OrderBY.$Limit;
  ...
  <tbody>
    <tr> 
      ...
      <td colspan="20" align="right">
        <a title=" Export to Excel " href="<?=URL?>pis_excel_gtfs_renewal.php" ><img src="images/excel_icon.gif" border="0" title="Download" /></a>
      </td>
    </tr>
		<?php
			}	
	...
	<tr> 
      <td colspan="20" align="left">
				<table>
				<tr>
						<td colspan="3" align="center"><strong>Branch PIS (GTFS RENEWAL)<br/><br/></strong></td>
					...
					<tr>
						...
						?>
							<input type="button" name="btnPis" value="Generate PIS" class="inplogin" onclick="javascript:popUp('<?php echo URL; ?>webadmin/window_pis_gtfs_renewal.php?pisdate=<?php echo $_POST['from_date']?>&pismode=<?php echo $_POST['pis_mode']?>')">
						<?php
						}	
						?>
						</td>
...
?>
	...
	<tr> 			
			...
			<td width="8%" align="center" valign="top" ><a href="javascript:void(0)" onclick="javascript:popUp('<?php echo URL; ?>webadmin/window_pis_gtfs_renewal_admin.php?id=<?php echo base64_encode($mysql_id); ?>')">View</a></td>
