  ...
  <tbody>
	...
	<tr> 
      ...
      <td colspan="20" align="right">
		...
		?>
    <tr class="TDHEAD"> 
      <td colspan="20">Direct Renewal Listing (SICL)</td>
    </tr>
		<!-- <tr>
...
?>
	...
	<tr> 
      <!-- <td width="8%" align="center" valign="top" ><input type="checkbox" name="received[]" value="<?php echo $mysql_id; ?>" <?php echo ($rs[$i]['hub_received'] == '1' ? 'checked' : '')?>></td>
			...
			<td width="8%" align="center" valign="top" ><?php echo ucwords($rs[$i]['applicant_name']); ?></td>
			
			<td width="8%" align="center" valign="top" ><?php echo find_plan($rs[$i]['plan']); ?></td>
			<td width="8%" align="center" valign="top" ><?php echo $rs[$i]['term']; ?></td>
			<td width="8%" align="center" valign="top" ><?php echo find_phase_name($rs[$i]['phase']); ?></td>
			<td width="8%" align="center" valign="top" ><?php echo find_installment_name($rs[$i]['installment_no']); ?></td>
