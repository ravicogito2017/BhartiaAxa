...
//$selTransaction = mysql_query("SELECT id, branch_id, customer_id, deposit_date, comitted_amount, amount, tenure, transaction_charges, insured_name, last_name, phone, email FROM renewal_master_gtfs WHERE is_deleted=0 ORDER BY id DESC");
  ...
  <tbody>
    <tr> 
      ...
      <td colspan="25" align="right">
        <a title=" Export to Excel " href="<?=URL?>renewal_excel_gtfs.php" ><img src="images/excel_icon.gif" border="0" title="Download" /></a>
      </td>
    </tr>
	...
	<tr> 
      <td colspan="25" align="left">
				<table>
					...
					<tr>
						<td width="150"><strong>Policy No.</strong></td>
						<td width="20"><strong>:</strong></td>
						<td width="150">
    ...
    <tr class="TDHEAD"> 
      <td colspan="25">Renewal Listing (GTFS)</td>
    </tr>
    ...
    <tr> 
      <td width="8%" align="center" valign="top" class="tbllogin">PIS Generated</td>
			...
			<td width="8%" align="center" valign="top" class="tbllogin">Policy No.</td>
	...
	if($pageRecordCount > 0)
	{
		for($i=0;$i<count($rs);$i++) { 
		 ...
		 else
		 {
			...
			//$selMasterRecord = mysql_query("SELECT customer_id, insured_name, middle_name, last_name, phone, email FROM customer_master WHERE id='".$rs[$i]['customer_id']."'");
	...
	<tr> 
      <td width="8%" align="center" valign="top" ><?php echo (intval($rs[$i]['pis_id']) != 0 ? 'Yes' : 'No'); ?></td>
			...
			<?php if($_SESSION[ROLE_ID] == '1'){?>
				<a href="javascript:void(0)" onclick="javascript:popUp('<?php echo URL; ?>webadmin/window_renewal_edit_gtfs.php?id=<?php echo base64_encode($mysql_id); ?>')">Edit</a>		
				<?php }?>
			</td>
			<td width="8%" align="center" valign="top" >			
				<a href="javascript:void(0)" onclick="javascript:popUp('<?php echo URL; ?>webadmin/window_renewal_gtfs.php?id=<?php echo base64_encode($mysql_id); ?>')">Generate</a>		
			</td>
			<?php
			...
			<td width="8%" align="center" valign="top" >
			<?php if($_SESSION[ROLE_ID] == '1'){ ?>
			<a href="javascript:void(0)" onclick="javascript:popUp('<?php echo URL; ?>webadmin/window_cancel_renewal_gtfs.php?id=<?php echo base64_encode($mysql_id); ?>')">Cancel</a>
			<?php } ?>
