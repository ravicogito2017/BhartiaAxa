...
{
	mysql_query("INSERT INTO pis_sp_master SET 
	...
	$previousID = mysql_insert_id();
		...
		$update_main_payment = "UPDATE insurance_short_premium SET pis_id='".$previousID."' WHERE id IN(".$_POST['idstr_alt_payment'].")";
...
$where = "WHERE amount != '0' AND sp_payment_mode != '' AND is_deleted = '0' ";
