...
{
	mysql_query("INSERT INTO pis_sp_renewal_master_gtfs SET 
	...
	$previousID = mysql_insert_id();
		...
		$update_main_payment = "UPDATE renewal_short_premium_gtfs SET pis_id='".$previousID."' WHERE id IN(".$_POST['idstr_alt_payment'].")";
...
$where = "WHERE amount != '0' AND sp_payment_mode != '' ";
