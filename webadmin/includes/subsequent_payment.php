...
$bounce_charge = $rsCB[0]['value']; // Applicable for cheque bounce
	...
	else
	{
			...
			if($msg == '') // authenic entry
			{
				...
				$insert_installment = "INSERT INTO installment_master SET 
										...
										chq_bounce_charge = '".floatval($chq_bounce_charge)."',
	...
	<form name="addForm" id="addForm" action="" method="post" onsubmit="return dochk()">
		<TABLE class="table_border" cellSpacing=2 cellPadding=5 width="100%" align=center border=0>
			<tbody>
				...
				<tr> 
					<td class="tbllogin" valign="top" align="right">Cheque Bounce Charge<font color="#ff0000">*</font><br /></td>
					<td class="tbllogin" valign="top" align="center">:</td>
					<td valign="top" align="left"><input name="chq_bounce_charge" id="chq_bounce_charge" type="text" class="inplogin"  value="<?php echo ($getFolioRecord['cheque_bounce_status'] == '1' ?  $bounce_charge : '0.00'); ?>" maxlength="20" onKeyPress="return keyRestrict(event, '0123456789.')"></td>
				</tr>
