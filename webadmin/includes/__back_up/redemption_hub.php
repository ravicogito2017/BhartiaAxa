  ...
  <TBODY>
    ...
    <TR class=body onmouseover="this.bgColor='#F7F7F7'" onmouseout="this.bgColor=''"> 
      ...
      <TD class="<?=$cls?>" align="left"><?=find_customer_id_through_id($rs[$i]['customer_id'])?></TD>
			...
			<td width="8%" align="center" valign="top" ><input type="checkbox" name="redemption_request_received[]" value="<?php echo $rs[$i]['id']; ?>" <?php echo ($rs[$i]['redemption_request_received'] == '1' ? 'checked' : '')?>></td>
			...
			<td width="8%" align="center" valign="top" ><input type="checkbox" name="redemption_request_verified_by_hub[]" value="<?php echo $rs[$i]['id']; ?>" <?php echo ($rs[$i]['redemption_request_verified_by_hub'] == '1' ? 'checked' : '')?>></td>
			
			<td width="8%" align="center" valign="top" ><?php echo ($rs[$i]['admin_approval'] == '1' ? 'Yes' : 'No')?></td>

			<td width="10%" align="center" valign="top" ><?php if($rs[$i]['admin_approval'] == '1'){ ?><a href="javascript:void(0)" onclick="javascript:popUp('<?php echo URL;?>webadmin/window_delivery_person.php?id=<?php echo base64_encode($rs[$i]['id']);?>')">View <?php } ?></td>
			<?php
		if(intval($_SESSION[ROLE_ID]) != 4) // NOT FOR BRANCH
			{ 
	?>
			<td width="8%" align="center" valign="top" ><?php if($rs[$i]['admin_approval'] == '1'){ ?><input type="checkbox" name="received[]" value="<?php echo $rs[$i]['id']; ?>" <?php echo ($rs[$i]['hub_received'] == '1' ? 'checked' : '')?>> <?php } ?></td>

			<td width="10%" align="center" valign="top" ><?php if($rs[$i]['hub_received'] == '1'){ ?><a href="javascript:void(0)" onclick="javascript:popUp('<?php echo URL;?>webadmin/window_hub_received_person.php?id=<?php echo base64_encode($rs[$i]['id']);?>')">Add</a> <?php } ?></td>
			...
			<td width="10%" align="center" valign="top" ><?php if($rs[$i]['hub_received'] == '1'){ ?><a href="javascript:void(0)" onclick="javascript:popUp('<?php echo URL;?>webadmin/window_hub_delivery_person.php?id=<?php echo base64_encode($rs[$i]['id']);?>')">Add</a> <?php } ?></td>
			...
			<td width="10%" align="center" valign="top" ><?php if((intval($rs[$i]['receipt_generated']) == 1) && ($rs[$i]['hub_delivery_person_emp_code'] != '')){ ?><a href="javascript:void(0)" onclick="javascript:popUp('<?php echo URL;?>webadmin/window_receipt_upload.php?id=<?php echo base64_encode($rs[$i]['id']);?>')">View or Upload<?php } ?> </td>
