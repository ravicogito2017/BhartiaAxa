  ...
  <tbody>
    <tr> 
      ...
      <td colspan="25" align="right">
        <a title=" Export to Excel " href="<?=URL?>renewal_excel_gtfs_branch.php" ><img src="images/excel_icon.gif" border="0" title="Download" /></a>
      </td>
    </tr>
...
?>
	<tr> 
      <td width="8%" align="center" valign="top" ><?php echo (intval($rs[$i]['pis_id']) != 0 ? 'Yes' : 'No'); ?></td>
			...
			<a href="javascript:void(0)" onclick="javascript:popUp('<?php echo URL; ?>webadmin/window_renewal_app_no_edit_gtfs.php?id=<?php echo base64_encode($rs[$i]['id']); ?>')">Edit<?php } ?>			
			</td>
			<td width="8%" align="center" valign="top" >
