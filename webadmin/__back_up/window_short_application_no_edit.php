...
$app_id = base64_decode($_GET['id']); 
	...
	if(isset($_POST['charge']) && !empty($_POST['charge']))
	{
		...
		$update_folio = "UPDATE insurance_short_premium  SET application_no = '".$charge."' WHERE id = '".$app_id."'";		//echo $update_folio;
		//exit;
...
<?php
	...
	$selTransaction = "SELECT application_no FROM insurance_short_premium WHERE id='".$app_id."'";
...
<script type="text/javascript" src="<?=URL?>js/site_scripts.js"></script>
 ...
 <form name="addForm" id="addForm" action="" method="post" onsubmit="return dochk()">
    ...
    <tr class="TDHEAD"> 
      <td colspan="3">Update Application No.</td>
    </tr>
		
	<tr> 
      <td width="27%" align="right" valign="top" class="tbllogin">Short Premium Amount</td>
