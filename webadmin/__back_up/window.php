...
function find_receipt_status($receipt_id)
{
	...
	//echo $invoice_id;
	$selTransaction = mysql_query("SELECT receipt_generated FROM installment_master WHERE id='".$receipt_id."'");
...
<table width="700" border="0" cellpadding="0" cellspacing="0" align="center" style = "padding-top:10px;">
				...
				<table>
					<tr>
					  ...
					  <td width="552" align="center">
						...
						<p style="font-size: 13px;" align="center">License No. - 5389734
	...
	<table width="700" border="0" cellpadding="0" cellspacing="0" style="font-size: 10px" align="center">    	
		...
		<strong>Application No. : <?php echo $getTransaction['application_no']; ?></strong>
		</td>
		</tr>
	...
	<br/><br/>
	  <div style="width:700px; margin:0 auto; text-align:left; padding-top:1px;">Received with thanks from<strong> <?php 
				echo $getTransaction['first_name'].' '.$getTransaction['middle_name'].''.$getTransaction['last_name']; ?></strong>a sum of Rs <strong><?php echo $getTransaction['main_amount']; ?></strong>/- by 
		...
		?>
			towards FP ( <strong><?php echo $data2['frequency']; ?></strong> Premium) in relation to above Proposal for  & on behalf of Life Insurance Corporation of India under<strong> <?php echo $data['plan_name'];?> </strong> and term<strong> <?php echo $getTransaction['tenure']; ?></strong> Years.</div>
	<br/>
	<br/>
	<br/>
	...
	<table width="700" border="0" style="padding:0 10px 0 0;">
	  ...
	  <td width="251" align="center" class="font9px" height="40px;" valign="middle" rowspan="2">
...
<table width="700" border="0" cellpadding="0" cellspacing="0" align="center" style="padding:40px;" >
...
<br/>
	...
	<br/><br/>
	  <div style="width:700px; margin:0 auto; text-align:left; padding-top:1px;">Received with thanks from<strong> <?php 
		...
		?>
			towards FP ( <strong><?php echo $data2['frequency']; ?></strong> Premium) in relation to above Proposal for  & on behalf of Life Insurance Corporation of India under<strong> <?php echo $data['plan_name'];?> </strong> and term<strong> <?php echo $getTransaction['tenure']; ?></strong> Years.</div><br/>
	<br/><br/>
