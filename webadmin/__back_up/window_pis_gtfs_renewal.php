...
{
	mysql_query("INSERT INTO pis_master_gtfs_renewal SET 
	...
	{
		$update_main_payment = "UPDATE renewal_master_gtfs SET pis_id='".$previousID."' WHERE id IN(".$_POST['idstr_main_payment'].")";
	...
	{
		$update_alt_payment = "UPDATE renewal_master_gtfs SET alt_pis_id='".$previousID."' WHERE id IN(".$_POST['idstr_alt_payment'].")";
...
$Query = "SELECT * FROM renewal_master_gtfs ".$where.$OrderBY;
 ...
 <div>
	 <table style="width:700px;">		 
		 ...
		 <tr>
			<td colspan="3" align="center">
				<strong>
					<div style="width:49%; float: left; text-align:left; ">Pay In Slip Number (Renewal Entry GTFS) : <?php echo (intval($previousID) != 0 ? str_pad($previousID, 7, "0", STR_PAD_LEFT) : ''); ?></div>
		...
		?>
					...
					<tr>
						...
						<td width="280" style="padding-top:5px;"><?php echo $rs[$i]['transaction_id']; ?></td>
